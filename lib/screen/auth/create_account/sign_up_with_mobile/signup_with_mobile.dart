...
import 'package:sketch/screen/auth/create_account/sign_up_with_mobile/signup_controller.dart';
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                        border:
                            Border.all(color: ColorRes.colorEBEBEB, width: 1),
                            ...
                            child: Container(
                              ...
                              child: Text(
                                ...
                                style: const TextStyle(
                                    fontSize: 14, color: ColorRes.colorB5B5B5),
                              ),
                            ),
                          ),
                          Container(
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                hintStyle: TextStyle(
                                    color: ColorRes.colorB5B5B5, fontSize: 14),
                              ),
                            ),
                          ),
                        ],
