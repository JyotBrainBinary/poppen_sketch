...
static String nearMe = "${icons}nearMe.png";
static String places = "${icons}places.png";
static String favourites = "${icons}favourites.png";
static String notifications = "${icons}notifications.png";
static String meIcon = "${icons}meIcon.png";
